...
### OUPUT - synthetic_trajs.json : synthetic trajectories generated by the trained GMM model.
...
for i, arrdep_ind in enumerate(arrdep_mix):
    ...
    traj_smooth[:, 1] = PchipInterpolator(t_smooth_0, traj_smooth_0[:,1])(t_smooth)
    traj_smooth[:, 2] = PchipInterpolator(t_smooth_0, traj_smooth_0[:,2])(t_smooth)
    traj_smooth[:, 3] = PchipInterpolator(t_smooth_0, traj_smooth_0[:,3])(t_smooth) 

    all_recon_trajs.append(traj_smooth.tolist())     
